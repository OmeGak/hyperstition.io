...
const gl = glcanvas.getContext("webgl2", { antialias: true, preserveDrawingBuffer: false });

if (!gl) {
  document.body.style.background = "#050505";
} else {
  const programInfo = twgl.createProgramInfo(gl, [window.vertexShaderSource, window.fragmentShaderSource]);
